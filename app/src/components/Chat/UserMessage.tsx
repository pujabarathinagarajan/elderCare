    ...
    <div className={classNames("py-4 px-2 md:px-0")}>
      <div className=" max-w-2xl mx-auto md:flex md:items-center group">
        <div className="flex items-start w-full max-w-[620px]">
          ...
          {!edit ? (
            <p className={classNames(" dark:text-black overflow-x-auto")}>
              {chat.content}
            </p>
          ) : (
            <textarea
        ...
        <div className=" md:invisible group-hover:visible  text-right">
          {!edit && (
            <button
              className="edit md:ml-8 dark:text-black  text-black text-xl "
      ...
      {edit && (
        <div className=" max-w-2xl mx-auto flex items-center group justify-center font-bold mt-4">
          ...
          <button
            className=" p-2 bg-transparent border dark:hover:bg-white hover:bg-white focus:border-2 hover:border border-gray-600 rounded-md text-black dark:text-white"
            onClick={() => setEdit((prev) => !prev)}
          >
            Cancel
          </button>
