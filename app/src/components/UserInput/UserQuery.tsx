...
export default function UserQuery() {
  ...
  return (
    <form
      className="input shadow-md dark:bg-[white] bg-#40414f  dark:border-#40414f border-gray-700 border-2 flex items-center   rounded-md"
    ...
    >
      <div className="w-11/12 p-2">
        <textarea
          name="query"
          ref={textareaRef}
          className="h-6 px-2  w-full outline-none resize-none dark:bg-transparent dark:text-black placeholder:font-bold"
      ...
      <div className=" w-1/12 text-center mx-2">
        <button
          ...
          className={classNames(
            " text-center  text-black dark:text-black transition inline-flex items-center justify-center py-2 px-2 rounded-md",
            { "bg-green-500 dark:text-black text-black": query }
          )}
        >
