  ...
  return (
    ...
    >
      {ideas.map((i) => (
        <button
          // key={i.idea}
          className="border inline-flex dark:border-gray-500 border-gray-300 hover:bg-gray-200 dark:hover:bg-gray-100 mb-2  w-full text-left p-2 group rounded-md  shadow flex-1 md:flex-row md:items-center"
          onClick={() => {
        ...
        >
          ...
          <div className="btn text-gray-600 dark:text-gray-600 text-lg invisible duration-75 transition-all group-hover:visible ">
